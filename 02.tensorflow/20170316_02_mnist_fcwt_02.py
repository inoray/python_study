...
with tf.name_scope("cost") as scope:
    ...
    cross_summ = tf.summary.scalar("cost", cross_entropy)
...
for i in range(2000):
    ...
    if i % 100 == 0:
        ...
        print("step %d, train_cross_entropy %f, training accuracy %g" % (i, train_cross_entropy, train_accuracy))
        costs.append(train_cross_entropy)
